...
public class C04_RadioButtons {
    ...
    public void yazidanSecmeTesti(){
        ...
        WebElement erkekChecckbox = driver.findElement(By.id("inlineRadio2"));
        WebElement kadinChecckbox = driver.findElement(By.id("inlineRadio1"));
        WebElement digerChecckbox = driver.findElement(By.id("inlineRadio3"));

        erkekCheckboxYaziElementi.click();
        ReusableMethods.bekle(2);

        Assertions.assertTrue(erkekChecckbox.isSelected());
        Assertions.assertFalse(kadinChecckbox.isSelected());
        Assertions.assertFalse(digerChecckbox.isSelected());
